...
public class WordReadFormulas {
 ...
 public static void main(String[] args) throws Exception {
  ...
  XWPFDocument document = new XWPFDocument(new FileInputStream("res//example.docx"));
...
public class ExtractQuestion {  
    public static void main(String[] args) {  
         try(FileInputStream fis = new FileInputStream("C:\\Users\\RR\\SkyDrive\\Documents\\example.docx")) {  
